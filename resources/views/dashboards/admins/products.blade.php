                                    ...
                                    cell.html(`
                                        <select name="category" class="form-control">
                                            ...
                                            <option value="Dry Goods" ${cell.text() === 'Dry Goods' ? 'selected' : ''}>Dry Goods</option>
                                              <option value="Frozen Goods" ${cell.text() === 'Frozen Goods' ? 'selected' : ''}>Frozen Goods</option>
                                                <option value="Personal Hygiene" ${cell.text() === 'Personal hygiene' ? 'selected' : ''}>Personal Hygiene</option>
                                                  <option value="Snacks" ${cell.text() === 'Snacks' ? 'selected' : ''}>Snacks</option>
                                                   <option value="Snacks" ${cell.text() === 'Dairy Products' ? 'selected' : ''}>Dairy Products</option>
                                        </select>
                                    `);
