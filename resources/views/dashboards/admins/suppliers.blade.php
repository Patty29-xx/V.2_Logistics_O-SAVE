                    ...
                    <form id="supplierForm" name="supplierForm" class="form-horizontal">
                        ...
                        <div class="container">
                                    <div class="form-group row">
                                        <label for="name" class="col-sm-4 col-form-label text-osave">Company Name*</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="name" name="name" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="rname" class="col-sm-4 col-form-label text-osave">Reprensetative Name*</label>
                                        <div class="col-sm-8">
